...

{
  ...
  check('208 school cards', d.querySelectorAll('#schoolList .card').length === 208);
  ...
  privCb.click();
  check('recheck private restores schools', d.querySelectorAll('#schoolList .card').length === 208);
...
}
{
  ...
  await tick(400);
  const d = dom.window.document;
  check('all 208 schools carry program grades', (html.match(/,g:\{exp:/g) || []).length === 208);
  check('all 208 schools carry vitals', (html.match(/,st:\{enroll:/g) || []).length === 208);
  check('all 208 schools carry diversity data', (html.match(/,dv:\{soc:/g) || []).length === 208);
  ...
  check('every fit grade is derived from its ratio', fitBad === 0 && fitOK === 208);
  ...
  check('all 208 schools carry about paragraphs', (html.match(/,about:\['/g) || []).length === 208);
