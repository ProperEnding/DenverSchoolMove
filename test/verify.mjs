...

{
  ...
  check('109 school cards', d.querySelectorAll('#schoolList .card').length === 109);
  ...
  privCb.click();
  check('recheck private restores schools', d.querySelectorAll('#schoolList .card').length === 109);
...
}
{
  ...
  await tick(400);
  const d = dom.window.document;
  check('all 109 schools carry program grades', (html.match(/,g:\{exp:/g) || []).length === 109);
  check('all 109 schools carry vitals', (html.match(/,st:\{enroll:/g) || []).length === 109);
  check('all 109 schools carry diversity data', (html.match(/,dv:\{soc:/g) || []).length === 109);
  ...
  check('every fit grade is derived from its ratio', fitBad === 0 && fitOK === 109);
  ...
  check('all 109 schools carry about paragraphs', (html.match(/,about:\['/g) || []).length === 109);
